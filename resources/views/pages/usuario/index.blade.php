        ...
        <form class="add-new-user modal-content pt-0">
            ...
            <div class="modal-body flex-grow-1">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control dt-full-name" id="fullname" placeholder="John Doe" name="fullname" aria-label="John Doe" aria-describedby="fullname2" />
                </div>
                <div class="form-group">
                    <label class="form-label" for="email">Email</label>
                    <input type="email" id="email" class="form-control dt-email" placeholder="john.doe@example.com" aria-label="john.doe@example.com" aria-describedby="email2" name="email" />
                    <small class="form-text text-muted"> Você pode usar letras, números e pontos </small>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label" for="user-role">Tipo de usuário</label>
        ...
        <section class="app-user-list">
            ...
            <div class="card" >
                <div class=" " style="width: 100%;">
                    <table class="user-list-table table table-sm table-responsive-lg" >
...
@push('js_page')
    ...
    <script src="../../../app-assets/js/scripts/pages/app-produto-list.js"></script>
@endpush
